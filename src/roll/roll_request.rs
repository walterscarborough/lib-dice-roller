...
use crate::roll::roll_request::roll_request_generated::{FlatbufferRollRequest, FlatbufferRollRequestArgs, get_root_as_flatbuffer_roll_request};
...
impl RollRequest {
    pub fn to_flatbuffer(&self) -> Vec<u8> {
        ...
        let flatbuffer_roll_request = FlatbufferRollRequest::create(&mut builder, &FlatbufferRollRequestArgs{dice_size: self.dice_size, number_of_rolls: self.number_of_rolls});
    ...
    pub fn from_flatbuffer(flatbuffer_data: Vec<u8>) -> RollRequest {
        let flatbuffer_roll_request = get_root_as_flatbuffer_roll_request(flatbuffer_data.as_slice());
