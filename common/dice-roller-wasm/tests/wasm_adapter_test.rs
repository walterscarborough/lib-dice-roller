...
use dice_roller_wasm::adapters::wasm::wasm_adapter::{convert_protobuf_to_js_array, wasm_roll_dice, convert_js_array_to_protobuf};
...
fn wasm_roll_dice_should_succeed() {
    ...
    let js_roll_response_protobuf =
        wasm_roll_dice(&js_roll_request_protobuf).expect("should be able to run wasm_roll_dice");
